		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Freight Vendor",
									"targetURL": "#sapbtpfreightvendorui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpfreightvendorui-display": {
								"semanticObject": "sapbtpfreightvendorui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.freightvendorui",
									"url": sap.ui.require.toUrl("sap/btp/freightvendorui")
								}
							}
						}
					}
